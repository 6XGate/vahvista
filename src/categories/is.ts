...
export const is = {
    isUndefined:         vahvista.register("undefined", isUndefined),
    isNull:              vahvista.register("null", isNull),
    isNil:               vahvista.register("nil", isNil),
    ...
    isArray:             vahvista.register("array", isArray),
    ...
    isEnum:              vahvista.factory<number|string>("enum", (values: (number|string)[]) => value => values.includes(value)),
